...
const Button: React.FC<ButtonProps> = ({ text, heroIcon: Icon, link }) => {
  return (
    <Link
      href={link}
      className="w-80 h-48 flex flex-col justify-center items-center block p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100  opacity-80"
      passHref
    >
