...
const FaqContainer: React.FC<FaqContainerProps> = ({
  ...
  return (
    ...
    >
      ...
      >
        {isLoading && (
          <div className="w-full h-full rounded-md flex flex-col justify-center items-center block p-6 text-gray-900  opacity-80 ">
            Loading...
          </div>
        )}
        ...
        <iframe
          ...
          height={childContainerHeight}
          width={childContainerWidth}
          src="https://gallegoprada360.com/cambio-tarifa/"
          frameBorder="0"
          allowFullScreen
